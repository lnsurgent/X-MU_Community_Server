...
public:
	...
	void SetVipStatus(LPSTR AccountID, int Duration, int vipType);
	void UpdateVipStatus(int Duration);
	void RemoveVipStatus(int value);
	BOOL GetVipInfo(LPSTR AccountId, int aIndex);
	BOOL CheckVipStats(char * AccountId);
	int GetVipType(char* szAccountId);
	// ----
#if( __MUANGEL__ == 1 )
