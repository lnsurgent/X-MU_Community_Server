...
void Settings::ReadData(char * File)
{
	...
	else
	{
		...
		GetPrivateProfileString("Connect", "DBLogin", "sa", this->ConnectLogin, sizeof(this->ConnectLogin), File);
		GetPrivateProfileString("Connect", "DBPassword", "pass", this->ConnectPassword, sizeof(this->ConnectPassword), File);
		// ----
		CString Text;
