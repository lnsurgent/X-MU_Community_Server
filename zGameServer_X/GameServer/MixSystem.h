...
enum CHAOS_TYPE	//-> Complete (All positions & names are original for 1.01.00)
{
	...
	CHAOS_TYPE_NEWWINGS_PART1_MIX				= 80,
};
// -------------------------------------------------------------------------------
...
public:
	...
	BOOL		Check4thWingItem(int iItemCode);
	...
	void		FourthWingMixFail(LPOBJ lpObj);
	void		ThirdWingMixFailItemPanalty(CItem * lpItem);
	void		FourthWingMixFailItemPanalty(CItem * lpItem);
	...
	void NewWingsMix_Part1(LPOBJ lpObj);
	// ----
private:
